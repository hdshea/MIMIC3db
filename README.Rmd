...
1. you are in the base directory of an RStudio project that has a `tests` directory and a `sql` directory defined in it,
2. you have loaded you have loaded the SQL scripts from  [this GitHub directory](https://github.com/hdshea/MIMIC3db/tree/main/inst/extdata) into the `tests` directory, and
